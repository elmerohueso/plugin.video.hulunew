...
def log(txt):
       message = '%s: %s' % ("HULU : stream_hulu.py :", txt)
        ...
        while qt < 8:
            ...
            for vid in video:
                ...
                if qtext in vid['profile']:
                    if (vid['cdn'] == common.settings['defaultcdn']) or (vid['cdn'] == common.settings['fallbackcdn']):
